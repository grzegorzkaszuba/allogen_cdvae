...
def main(args):
    ...
    if 'localsearch_dataset' in args.tasks:
        ...
        # localsearch params
        n_steps = 2 # this is how many steps the algorithm will do
        n_samples = 7 # this is how many transpositions the algorithm will check before picking the best one
